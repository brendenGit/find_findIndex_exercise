...
and a string. The function should remove the object from the array. If the object is not found, return undefined. 
...
function removeUser(usersArray, username) {
  const test = usersArray.findIndex(function (value, index, array) {
    return value['username'] === username;
  })
  if (test != -1) {
    return newArray = usersArray.splice(test, 1)[0];
  }
}